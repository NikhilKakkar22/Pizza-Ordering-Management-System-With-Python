...
#--  page 1------
    def main(sf):
        ...
        sf.scr.geometry("1920x1030")
        sf.scr.title("Prabhat's PIZZA SAFARI")
...
#------ page 2------
    def Login(sf):
        ...
        sf.scr.destroy()
        sf.scr=Tk()
        sf.scr.title("Prabhat's Pizza House")
        sf.scr.geometry("1920x1030")
        #sf.scr.resizable(False, False)
        ...
        sf.rg=Button(sf.loginf2,text="New to Prabhat's Pizza House",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
        ...
        sf.url=Label(sf.loginf2,image=sf.ext,cursor="hand2").place(x=938,y=125)
